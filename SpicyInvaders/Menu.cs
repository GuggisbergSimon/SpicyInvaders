...
namespace SpicyInvaders
{
	...
	public class Menu
	{
		...
		private const string _ABOUT_1 =
			"The project Spicy Invaders is a true copy of the famous game Space Invaders. The goal wasn't to steal the concept, " +
		...
		private const string _ABOUT_2 =
			"We are a team of four young developers. Simon Guggisberg, Ylli Fazlija, Hugo Ducommun and Karim Boraley. This project " +
